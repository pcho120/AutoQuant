    ...
    <div className="app-shell">
      <header className="app-bar">
        ...
        <div className="app-actions">
          ...
          <button className="icon-button" title="Theme" aria-label="Theme"><Moon size={18} /></button>
        ...
        <main className="dashboard">
            ...
            <div className="positions-card">
              ...
              <div className="table-scroll">
                <table className="positions-table">
                  <thead><tr><th>Ticker</th><th>Quantity</th><th>Buy Price</th><th>Current Price</th><th>Market Value</th><th>P/L ($)</th><th>P/L (%)</th></tr></thead>
                  <tbody>
              ...
              <div className="table-actions">
                <span>Data refreshed {lastUpdatedSeconds}s ago</span>
                <div>
          ...
          <section className="analysis-section">
            ...
            <div className="market-card">
              ...
              {marketQuery.data && <MarketCharts data={marketQuery.data} />}
            </div>
          </section>
        </main>
      )}
